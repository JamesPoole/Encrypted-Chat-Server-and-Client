  ...
  fileReader.onloadend = function() {
   ...
   function sendChunk() {
    ...
    if ($('#encryptChat').is(":checked")) {
     ...
     if (aesKab) { // only generate the AES key once
      encryptFileAES(aesKab, chunk, iv).then((encryptedChunk) => {
      ...
      console.log("Encryption protocol has not finished, please try again");
     }
    } else {
     socket.once('socket.io-file::request::' + uploadId, sendChunk);
